    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=50, null=True, validators=[django.core.validators.RegexValidator(message='Invalid format.', regex='^[a-zA-Z]+$'), account.validators.name_length_validation])),
                ('last_name', models.CharField(blank=True, max_length=50, null=True, validators=[django.core.validators.RegexValidator(message='Invalid format.', regex='^[a-zA-Z]+$'), account.validators.name_length_validation])),
